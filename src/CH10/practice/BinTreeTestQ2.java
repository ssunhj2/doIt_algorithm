...
public class BinTreeTestQ2
{
	...
	enum Menu {
		...
		SEARCH("검색"),
		MIN_KEY("가장 작은 키 출력"),
		MIN_VALUE("가장 작은 키의 데이터 출력"),	
		MAX_KEY("가장 큰 키 출력"),
		MAX_VALUE("가장 큰 키의 데이터 출력"),	
		PRINT_ASC("오름차순 출력"),
		PRINT_DESC("내림차순 출력"),		
		TERMINATE("종료");
	...
	public static void main(String[] args) 
	{
		...
		BinTreeQ2<Integer, Data> tree = new BinTreeQ2<Integer, Data>();
		...
		do 
		{
			switch (menu = SelectMenu()) 
			{
				 ...
				 case MIN_KEY : 
						...
						break;
				 case MIN_VALUE : 
						System.out.println(tree.getMinKeyData());	
						break;		
				 case MAX_KEY :
						System.out.println(tree.getMaxKey());	
						break;
				 case MAX_VALUE :
						System.out.println(tree.getMaxKeyData());	
						break;				
