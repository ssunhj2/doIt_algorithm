 ...
 *
 */
public class ArrLinkedListTest_Q5 {
	...
	public static void main(String[] args) 
	{
		...
		ArrLinkedList_Q5<Data> list = new ArrLinkedList_Q5<Data>(100);
		...
		do 
		{
			switch (menu = SelectMenu())
			{
				 ...
				 { // 임의의 노드를 나타냄
					...
					{
						System.out.println("데이터는 " + ptr.toString() + "이다.");
					}
