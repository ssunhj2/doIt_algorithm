...
/**
 * 연습문제 Q1
 * 공집합 판단하는 메소드, 집합이 가득찼는지 확인하는 메소드, 집합을 초기화 하는 메소드를 추가한다.
 */
public class IntSet_Q1 
{
	private int max;
	private int num;
	private int[] set;
	
	public IntSet_Q1(int cap)
	{
		num = 0;
		max = cap;
	...
	// 집합 s의 값을 집합배열에 복사한다.
	public void copyTo(IntSet_Q1 s)
	{
	...
	// 집합 s에 집합배열을 복사한다.
	public void copyFrom(IntSet_Q1 s)
	{
	...
	// 집합과 집합s가 같은지 검사한다.
	public boolean equalTo(IntSet_Q1 s)	
	{
	...
	public void unionOf(IntSet_Q1 s1, IntSet_Q1 s2)
	{
