...
/**
 * 연습문제 Q2
 * 집합 s의 모든 요소를 추가하는 메소드를 작성한다.
 * 집합 s에 들어있는 요소만 남기고 나머지는 삭제하는 메소드를 작성한다.
 * 집합 s에 들어있는 요소를 삭제하는 메소드를 작성한다.
 * 메소드의 실행에 따라 집합이 변경되면 true, 아니면 false를 반환한다.
 */
public class IntSet_Q2 
{
	private int max;
	private int num;
	private int[] set;
	
	public IntSet_Q2(int cap)
	{
		num = 0;
		max = cap;
	...
	// 집합 s의 값을 집합배열에 복사한다.
	public void copyTo(IntSet_Q2 s)
	{
	...
	// 집합 s에 집합배열을 복사한다.
	public void copyFrom(IntSet_Q2 s)
	{
	...
	// 집합과 집합s가 같은지 검사한다.
	public boolean equalTo(IntSet_Q2 s)	
	{
	...
	public void unionOf(IntSet_Q2 s1, IntSet_Q2 s2)
	{
...
// Q2 ------------------------------------------------------//
	// 집합 s와의 합집합을 구한다.
	public boolean add(IntSet_Q2 s)
	{
	...
	// 집합 s와의 교집합을 구한다.
	public boolean retain(IntSet_Q2 s)
	{
		boolean result = false;
	...
	// 집합 s와의 차집합을 구한다.
	public boolean remove(IntSet_Q2 s)
	{
		boolean result = false;
