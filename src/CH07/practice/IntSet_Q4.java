...
/**
 * 연습문제 Q4
 * 집합에 대해 집합 s1과 s2의 교집합을 복사하는 메소드를 작성한다.
 * 집합에 대해 집합 s1과 s2의 차집합을 복사하는 메소드를 작성한다.
 */
public class IntSet_Q4 
{
	private int max;
	private int num;
	private int[] set;
	
	public IntSet_Q4(int cap)
	{
		num = 0;
		max = cap;
	...
	// 집합 s의 값을 집합배열에 복사한다.
	public void copyTo(IntSet_Q4 s)
	{
	...
	// 집합 s에 집합배열을 복사한다.
	public void copyFrom(IntSet_Q4 s)
	{
	...
	// 집합과 집합s가 같은지 검사한다.
	public boolean equalTo(IntSet_Q4 s)	
	{
	...
	public void unionOf(IntSet_Q4 s1, IntSet_Q4 s2)
	{
	...
	// 집합 s와의 합집합을 구한다.
	public boolean add(IntSet_Q4 s)
	{
	...
	// 집합 s와의 교집합을 구한다.
	public boolean retain(IntSet_Q4 s)
	{
		boolean result = false;
	...
	// 집합 s와의 차집합을 구한다.
	public boolean remove(IntSet_Q4 s)
	{
		boolean result = false;
	...
	// 집합 ( s
	public boolean isSubsetOf(IntSet_Q4 s)
	{
		for (int i = 0; i < num; i++) 
		{
			int j = 0;
	...
	// 집합 ( s && 집합 != s
	public boolean isProperSubsetOf(IntSet_Q4 s)
	{
...
// Q4 ------------------------------------------------------//	
	...
	public void intersectionOf(IntSet_Q4 s1, IntSet_Q4 s2)
	{
		clear();
	...
	public void differenceOf(IntSet_Q4 s1, IntSet_Q4 s2)
	{
		clear();
		for (int i = 0; i < s1.num; i++) 
		{
